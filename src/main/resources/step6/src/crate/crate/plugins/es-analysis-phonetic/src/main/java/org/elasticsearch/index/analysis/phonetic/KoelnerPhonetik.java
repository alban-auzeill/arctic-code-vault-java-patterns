/* (rank 122) copied from https://github.com/crate/crate/blob/9adb45ce79b19045b928be44cadf604d26ba067f/plugins/es-analysis-phonetic/src/main/java/org/elasticsearch/index/analysis/phonetic/KoelnerPhonetik.java
...
public class KoelnerPhonetik implements StringEncoder {
    ...
    private String expandUmlauts(String str) {
        return str.replaceAll("\u00C4", "AE").replaceAll("\u00D6", "OE").replaceAll("\u00DC", "UE"); //Needed
    }
