package com.vaadin.tests.components.grid; // (rank 209) copied from https://github.com/vaadin/framework/blob/2e8b9d2b5b40652321aaa9d2bb2dba1041da7fc4/uitest/src/test/java/com/vaadin/tests/components/grid/AbstractGridColumnAutoWidthTest.java
