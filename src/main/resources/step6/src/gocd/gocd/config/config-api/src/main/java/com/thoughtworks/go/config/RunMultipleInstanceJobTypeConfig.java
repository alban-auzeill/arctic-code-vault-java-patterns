/* (rank 195) copied from https://github.com/gocd/gocd/blob/fdbdbd4477cd8ae9b90b5dae883199f01fe00dce/config/config-api/src/main/java/com/thoughtworks/go/config/RunMultipleInstanceJobTypeConfig.java
