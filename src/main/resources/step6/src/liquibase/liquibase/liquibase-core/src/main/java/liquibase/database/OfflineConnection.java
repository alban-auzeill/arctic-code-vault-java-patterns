package liquibase.database; // (rank 350) copied from https://github.com/liquibase/liquibase/blob/43ed0e54adedc5f12c7933b998550e777d9b683d/liquibase-core/src/main/java/liquibase/database/OfflineConnection.java
