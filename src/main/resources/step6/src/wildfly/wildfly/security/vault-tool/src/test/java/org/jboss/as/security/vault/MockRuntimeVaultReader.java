package org.jboss.as.security.vault; // (rank 103) copied from https://github.com/wildfly/wildfly/blob/0780041b711baad2ce96668b2fbdb76ba91aa83b/security/vault-tool/src/test/java/org/jboss/as/security/vault/MockRuntimeVaultReader.java
...
public class MockRuntimeVaultReader extends RuntimeVaultReader {
  ...
  public void createVault(final String fqn, final Map<String, Object> options) throws VaultReaderException {
    ...
    try {
      ...
      if (t instanceof SecurityVaultException) {
        throw VaultLogger.ROOT_LOGGER.vaultReaderException(t);
      }
      if (t instanceof RuntimeException) {
        throw VaultLogger.ROOT_LOGGER.runtimeException(t);
      }
      throw VaultLogger.ROOT_LOGGER.runtimeException(t);
    }
    try {
      ...
      e.printStackTrace();
      throw VaultLogger.ROOT_LOGGER.vaultReaderException(e);
    }
    this.vault = vault;
  }
  ...
  public String retrieveFromVault(final String password) throws SecurityException {
    if (isVaultFormat(password)) {
      ...
      if (vault == null) {
        throw VaultLogger.ROOT_LOGGER.vaultNotInitializedException();
      }

      try {
        return getValueAsString(password);
      } catch (SecurityVaultException e) {
        throw VaultLogger.ROOT_LOGGER.securityException(e);
      }
